...
set output "GRAPH_FoV_mag_limit.tex"

set title ""
set xlabel 'Number of Pointings'
set ylabel 'Magnitude ($M$)'
unset key
set xrange[0:16]
#set yrange[-2.3:-1.2]
...
plot\
 "GRAPH_FoV_mag_limit.txt" using 1:2 pt 6 ps 0.7 lw 2 lc rgb "black" notitle
