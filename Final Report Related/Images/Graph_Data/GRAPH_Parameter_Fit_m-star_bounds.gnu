...
set output "GRAPH_Parameter_Fit_m-star_bounds.tex"
...
plot\
 "GRAPH_Parameter_Fit_m-star_bounds_data.txt" using 1:2 w l lw 4 lc rgb "#4d81be" t 'Predicated Value of $M^*$', \
 "GRAPH_Parameter_Fit_m-star_bounds_data.txt" using 1:3 w l lw 4 lc rgb "#c05048" t 'Upper Limit', \
 "GRAPH_Parameter_Fit_m-star_bounds_data.txt" using 1:4 w l lw 4 lc rgb "#9bbb59" t 'Lower Limit'
