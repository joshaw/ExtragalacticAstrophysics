...
set output "GRAPH_Parameter_Fit_alpha_linear.tex"
...
#m = 0.5
#c = 20
fit f(x) "GRAPH_Parameter_Fit_alpha_data.txt" using ($1):($3) via m, c
...
plot\
 "GRAPH_Parameter_Fit_alpha_data.txt" using 1:3:($1-$2):($1+$2):($3-$5):($3+$4) with xyerrorbars pt 6 ps 0.7 lw 2 lc rgb "black" notitle, f(x) lw 3 lc rgb "red" t titlef
