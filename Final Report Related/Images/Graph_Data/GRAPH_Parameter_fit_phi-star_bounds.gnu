...
set output "GRAPH_Parameter_Fit_phi-star_bounds.tex"

set title ""
set xlabel 'Redshift ($z$)'
set ylabel 'Normalisation ($\phi^*$)'
set key at 17,0.18
#set xrange[0:16]
#set yrange[-2.3:-1.2]
...
plot\
 "GRAPH_Parameter_fit_phi-star_bounds_data.txt" using 1:2 w l lw 4 lc rgb "#4d81be" t 'Predicated Value of $\phi^*$', \
 "GRAPH_Parameter_fit_phi-star_bounds_data.txt" using 1:3 w l lw 4 lc rgb "#c05048" t 'Upper Limit', \
 "GRAPH_Parameter_fit_phi-star_bounds_data.txt" using 1:4 w l lw 4 lc rgb "#9bbb59" t 'Lower Limit'
