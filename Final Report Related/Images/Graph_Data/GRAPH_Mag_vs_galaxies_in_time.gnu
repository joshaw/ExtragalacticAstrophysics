...
set output "GRAPH_Mag_vs_galaxies_in_time.tex"
...
plot\
 "GRAPH_Mag_vs_galaxies_in_time_data.txt" using 1:2 pt 6 ps 0.7 lw 4 lc rgb "#4d81be" t '\SI{0.1e6}{\second}', \
 "GRAPH_Mag_vs_galaxies_in_time_data.txt" using 1:3 pt 2 ps 0.7 lw 4 lc rgb "#c05048" t '\SI{0.2e6}{\second}', \
 "GRAPH_Mag_vs_galaxies_in_time_data.txt" using 1:4 pt 1 ps 0.7 lw 4 lc rgb "#9bbb59" t '\SI{0.5e6}{\second}'
