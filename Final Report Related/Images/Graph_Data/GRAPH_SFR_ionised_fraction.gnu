...
set output "GRAPH_SFR_ionised_fraction.tex"

set title ""
set xlabel 'Redshift ($z$)'
set ylabel 'Ionised Fraction'
set key at 24,1
#set xrange[0:16]
set yrange[:1.1]
...
plot\
 "GRAPH_SFR_ionised_fraction.txt" using 1:2 w l lw 4 lc rgb "#4d81be" t 'Ionised Fraction', \
 "GRAPH_SFR_ionised_fraction.txt" using 1:3 w l lw 4 lc rgb "#c05048" t 'Upper Limit', \
 "GRAPH_SFR_ionised_fraction.txt" using 1:4 w l lw 4 lc rgb "#9bbb59" t 'Lower Limit'
